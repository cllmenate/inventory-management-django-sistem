...
class TestProductModelViews:
    def test_product_model_list_view(
    ...
    def test_product_model_create_view(
        self, client, authenticated_user, brand
    ):
        client.force_login(authenticated_user)
    ...
    def test_product_model_detail_view(
        self, client, authenticated_user, product_model
    ):
        client.force_login(authenticated_user)
    ...
    def test_product_model_update_view(
        self, client, authenticated_user, product_model
    ):
        client.force_login(authenticated_user)
    ...
    def test_product_model_delete_view(
        self, client, authenticated_user, product_model
    ):
        client.force_login(authenticated_user)
    ...
    def test_product_model_export_view(
        self, mock_task, client, authenticated_user
    ):
        client.force_login(authenticated_user)
...
class TestProductModelAPI:
    ...
    def test_product_model_retrieve_update_destroy_api(
        ...
        api_client.force_authenticate(user=authenticated_user)
        url = reverse(
            "product_model_detail_api_view", kwargs={"pk": product_model.pk}
        )
