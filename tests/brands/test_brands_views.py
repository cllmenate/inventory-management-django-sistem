...
class TestBrandViews:
    ...
    def test_brand_list_view_filter(
        self,
        client,
        authenticated_user,
        brand,
...
@pytest.mark.django_db
class TestBrandAPI:
    def test_brand_list_create_api(
        self,
        api_client,
        authenticated_user,
    ):
